...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $gantry->language; ?>" lang="<?php echo $gantry->language;?>" >
    <head>
        <?php
            $gantry->displayHead();
            $gantry->addStyles(array('template.css','wordpress.css','wp.css','typography.css','iphone-gantry.css','overlays.css'));
    ...
    <body <?php echo $gantry->displayBodyTag(); ?> onorientationchange="orient()">
		<div id="rt-wrapper">
			...
			<div id="rt-header" <?php echo $gantry->displayClassesByTag('rt-header-surround'); ?>><div id="rt-header2">
				<div class="rt-container">
			...
			<?php /** Begin Main Body **/ ?>
			<div id="rt-body-surround" <?php echo $gantry->displayClassesByTag('rt-body-surround'); ?>><div id="rt-body-bg2">
		    <?php echo $gantry->displayMainbody('iphonemainbody','sidebar','standard','standard','standard','standard','standard'); ?>
			</div></div>
			<?php /** End Main Body **/ ?>
			<?php /** Begin Footer **/ if ($gantry->countModules('mobile-footer') or ($gantry->countModules('mobile-copyright'))): ?>
			<div id="rt-footer-surround" <?php echo $gantry->displayClassesByTag('rt-footer-surround'); ?>><div id="rt-footer-surround2">
			<?php if ($gantry->countModules('mobile-footer')) : ?>
			<div id="rt-footer">
				<div class="rt-container">
			...
			<div id="rt-copyright" <?php echo $gantry->displayClassesByTag('rt-footer-surround'); ?>>
				<div class="rt-container">

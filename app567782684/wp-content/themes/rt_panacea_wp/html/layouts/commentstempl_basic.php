...
class GantryLayoutCommentsTempl_Basic extends GantryLayout {
    ...
    function render($params = array()) {
        ...
        <div id="comments" class="comments-basic">
        
            <h1 class="rt-pagetitle"><?php _re('Comments'); ?></h1>
        ...
        <div id="respond">
            ...
            <h1 class="rt-pagetitle"><?php comment_form_title(_r('Leave a Reply'), _r('Leave a Reply to %s')); ?></h1>

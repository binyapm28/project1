...
class GantryLayoutChrome_Standard extends GantryLayout {
    ...
    function render($params = array()){
        ...
        $params[0]['pre_render'] = '<div class="rt-module-surround"><div class="rt-module-inner"><div class="module-content">';
        $params[0]['post_render'] = '<div class="clear"></div></div></div></div>';

        $params[0]['title_open'] =  '<div class="module-title-surround"><div class="module-title"><h2 class="title">';

...
class PanaceaFusionMenuLayout extends AbstractRokMenuLayout {
    ...
    public function renderMenu(&$menu) {
		...
		<div class="nopill">
		<?php endif; ?>
        <ul class="menutop level1 theme-fusion <?php echo $isJSEnabled; ?>">
    ...
    protected function renderItem(RokMenuNode &$item, &$menu) {
        ...
        <li <?php if($item->hasListItemClasses()) : ?>class="<?php echo $item->getListItemClasses();?>"<?php endif;?> <?php if ($item->getCssId()): ?>id="<?php echo $item->getCssId();?>"<?php endif;?>>
            ...
            <span>
             ...
             ?>
             <?php if (!empty($icon)) : ?>
                 <img src="<?php echo $gantry->templateUrl.'/images/icons/'.$icon; ?>" alt="" />
             <?php endif; ?>

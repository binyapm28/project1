...
$contentOptions = ($instance['show_article_title'] == '1' || $instance['show_created_date'] == '1' || $instance['show_author'] == '1' || $instance['show_article'] == '1' || $instance['show_article_link'] == '1');
?>
				...
				<div class="description<?php echo $content_pad; ?>">
					...
					<?php if($instance['show_article'] == '1') : ?>
						...
						<?php if($instance['legacy_readmore'] == '1') : ?>
							<a href="<?php the_permalink(); ?>" class="article_link"><?php echo $instance['readmore_label']; ?></a>
						<?php endif; ?>

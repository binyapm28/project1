...
class RokAjaxSearch extends WP_Widget {
    ...
    function render($args, $instance) {
		...
		if(file_exists(TEMPLATEPATH. DS .'html'. DS .'plugins'. DS .'wp_rokajaxsearch'. DS .'default.php')) :	
	  		require(TEMPLATEPATH. DS .'html'. DS .'plugins'. DS .'wp_rokajaxsearch'. DS .'default.php');
	  	else :
	  		require($rokajaxsearch_plugin_path. DS .'tmpl'. DS .'default.php'); 
	  	endif;
